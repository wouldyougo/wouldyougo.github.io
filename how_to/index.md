...
## Синтаксис Markdown 
* [Синтаксис Markdown](http://ru.wikipedia.org/wiki/Markdown "http://ru.wikipedia.org/wiki/Markdown")
Markdown is an easy-to-write plain text format for creating web content. 
* See [Using Markdown with RStudio](http://www.rstudio.com/ide/docs/authoring/using_markdown) to learn more.
* See also: [Using Equations with Markdown](http://www.rstudio.com/ide/docs/authoring/using_markdown_equations).
